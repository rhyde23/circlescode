...
myfont6 = pygame.font.SysFont('Currier', 100)
...
change_formation_button = [300, 135, 130, 30, white, red, myfont3.render("CHANGE FORMATION", True, red), myfont3.render("CHANGE FORMATION", True, white)]
...
while manager_loop :
    while lineups :
        if player_reporting :
            ...
            display.blit(current_team_rating_text, (625, 250))
